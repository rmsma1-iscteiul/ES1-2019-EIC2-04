...
import project.backend.store.DataContainer;
import java.io.File;
...
public class Backend {
	...
	// parse file to ... (map?)
		...
		private DataContainer row_to_container(Row row) throws Exception {
			...
			DataContainer container = new DataContainer(methodID, packageName, className,method, lOC, cYCLO, aTFD, lAA, is_long_method, iPlasma, pMD, is_feature_envy); 
			return container;
		}
